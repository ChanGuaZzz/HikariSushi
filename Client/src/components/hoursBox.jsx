...
function HoursBox({hour, index, handleDelete}) {
  return (
    <div className=" py-2 bg-slate-300  rounded-lg w-full flex my-1 justify-evenly ">
        <h1 className=" py-1 px-10 bg-black bg-opacity-15 rounded-lg">{hour}</h1>
      <button onClick={() => handleDelete(index)} className="bg-black bg-opacity-15 rounded-full">
