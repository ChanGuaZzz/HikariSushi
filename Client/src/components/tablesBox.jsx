...
function TablesBox({ qty, capacity, index, handleDelete, handleEdit, isAddingTable, setIsAddingTable, qtyNewTable, setQtyNewTable, capacityNewTable, setCapacityNewTable }) {
  return (
    <>
      {isAddingTable ? (
