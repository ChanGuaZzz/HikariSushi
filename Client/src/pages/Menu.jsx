...
function Menu() {
  ...
  const categories = [
    ...
    { id: "sushi", name: "Sushi" },
    { id: "ramen", name: "Ramen" },
    { id: "robata", name: "Robata" },
    { id: "tempura", name: "Tempura" },
    { id: "bebidas", name: "Bebidas" }
  ];

  // Todos los platos del menú con sus categorías
  const allDishes = [
    {
      id: 1,
      name: "Nigiri Mixto",
    ...
    },
    {
      ...
      price: "$19.99",
      category: "ramen",
      description: "Caldo cremoso de hueso de cerdo cocido a fuego lento por 12 horas con chashu, huevo marinado y fideos artesanales.",
      image: "https://www.cocinadelirante.com/800x600/filters:format(webp):quality(75)/sites/default/files/images/2025/02/recetas-de-comida-japonesa-super-faciles-para-hacer-en-casa.jpg",
    },
    {
      id: 6,
      name: "Miso Ramen",
      ...
      image: "https://www.just-eat.es/CmsAssets/media/Images/Blogs/ES/comida-japonesa-que-va-mas-alla-del-sushi/Gyozas-con-salsa-de-soja.jpg",
    },
    {
      id: 7,
      ...
      price: "$32.99",
      category: "robata",
      description: "Ternera wagyu premium a la parrilla tradicional japonesa, servida con salsa trufa-ponzu y vegetales a la brasa.",
    ...
    },
    {
      ...
      image: "https://s3.ppllstatics.com/diariovasco/www/multimedia/201906/19/media/cortadas/gastronomia-japonesa-kVy-Ro95ukZoQHafokVAU7O2puO-624x385@Diario%20Vasco-koyH-Ro95ukZoQHafokVAU7O2puO-624x385@Diario%20Vasco-kDwG-Ro95ukZoQHafokVAU7O2puO-624x385@Diario%20Vasco.jpg",
    },
    {
      id: 10,
      name: "Sake Premium",
  ...
  return (
    <div className="bg-[#322a27] min-h-screen text-white font-sans">
        ...
        <div className="container mx-auto px-4 md:px-8 z-10 relative">
          <div className="max-w-2xl mx-auto text-center">
            ...
            <p className="text-lg mb-8">
              Descubre todos nuestros platos tradicionales japoneses, elaborados con los ingredientes más frescos y las técnicas ancestrales.
            </p>
          </div>
        </div>
      </section>
      ...
      <div id="menu-categories" className="bg-white text-[#322a27] py-6">
        <div 
          className={`w-full transition-all duration-300 ${
            isSticky ? "fixed top-0 left-0 z-20 shadow-md bg-white py-5 px-4" : ""
          }`}
        >
      ...
      <section className="py-12 bg-white text-[#322a27]">
        <div className="container mx-auto px-4 md:px-8">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {filteredDishes.map(dish => (
              <div key={dish.id} className="bg-[#322a27] rounded-xl overflow-hidden shadow-lg hover:shadow-xl transition-all">
                ...
                <div className="p-6">
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <button className="text-white hover:text-[#ff3e01] transition-colors text-sm">
                      Añadir +
                    </button>
                  </div>
                </div>
      ...
      <section className="py-14 bg-[#ff3e01]/10">
        <div className="container mx-auto px-4 md:px-8 text-center">
          ...
          <Link to="/login" className="bg-[#ff3e01] text-white px-8 py-3 rounded-full inline-block hover:bg-[#ff3e01]/80 transition-colors">
            Reservar Mesa
          </Link>
        </div>
      </section>
